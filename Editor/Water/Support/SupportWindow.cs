...
namespace Procrain.Editor.Water.Support
{
    ...
    {
        private static readonly string registryKeyShowWindow = "ameye.stylizedwaterforurp.showsupportwindow";

        static RunOnImport() => EditorApplication.update += OpenSupportWindow;

        public static bool shouldshowSupportWindow
        {
            get => EditorPrefs.GetBool(registryKeyShowWindow, true);
            set => EditorPrefs.SetBool(registryKeyShowWindow, value);
        }

        private static void OpenSupportWindow()
        {
    ...
    public class SupportWindow : EditorWindow
    {
        ...
        private static SearchRequest urpSearchRequest;
        private static AddRequest addRequest;

        private static Label unityVersionLabel;
        private static Label activeRendererLabel;
        private static Label URPVersionLabel;
        private static Label depthTextureLabel;
        private static Label opaqueTextureLabel;
        private static Label graphicsAPILabel;
        private static Label planarReflectionsLabel;
        private static Label shaderVariantLimitLabel;

        private static VisualElement unityVersionIcon;
        private static VisualElement activeRendererIcon;
        private static VisualElement URPVersionIcon;
        private static VisualElement depthTextureIcon;
        private static VisualElement opaqueTextureIcon;
        private static VisualElement graphicsAPIIcon;
        private static VisualElement planarReflectionsIcon;
        private static VisualElement shaderVariantLimitIcon;

        private static Button unityVersionFix;
        private static Button URPVersionFix;
        private static Button activeRendererFix;
        private static Button depthTextureFix;
        private static Button opaqueTextureFix;
        private static Button graphicsAPIFix;
        private static Button planarReflectionsFix;
        private static Button shaderVariantLimitFix;

        private static Button aboutButton;
        private static Button supportButton;
        private static Button configureButton;
        private static Button acknowledgementsButton;
        private static Button graphicsAPIButton;

        private static Texture2D neutral;
        private static Texture2D positive;
        private static Texture2D negative;
        ...
        private void Clickedbutton(EventBase tab)
        {
            ...
            switch (button.name)
            {
                ...
                case "Forum":
                    Application.OpenURL(
                        "https://forum.unity.com/threads/stylized-water-for-urp-desktop-mobile-released.846313/"
                    );
                    break;
                case "Caustics":
                    Application.OpenURL(
                ...
                case "Shader_Variant_Limit_Fix":
                    ...
                    var readMethod = typeof(UnityEditor.Editor).Assembly.GetType("UnityEditor.CacheServerPreferences")
                ...
                case "Depth Texture Fix":
                {
                    ...
                    var pipeline = activeRenderPipelineAsset as UniversalRenderPipelineAsset;
        ...
        private static void DetectIssues()
        {
            ...
            var planarReflectionComponents = 0;
            var planarReflections = FindObjectsOfType<PlanarReflections>();
        ...
        private static void FindSRPVersion()
        {
#if UNIVERSAL_RENDERER

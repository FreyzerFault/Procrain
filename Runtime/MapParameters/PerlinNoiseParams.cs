...
{
	public readonly struct PerlinNoiseParams_ThreadSafe: IHeightMapParams
	{
	...
	[CreateAssetMenu(menuName = "Map Generation", fileName = "Procrain/PerlinNoise Params")]
	public class PerlinNoiseParams : AutoUpdatableSoWithBackup<PerlinNoiseParams>, IHeightMapParams
	{

...
namespace Procrain.Runtime.Water
{
    ...
    public class StylizedWaterURP : MonoBehaviour
    {
        ...
        public void ReadMaterialProperties()
        {
            ...
            if (material.shader.name == shaderName || material.shader.name == underwaterShaderName)
        ...
        public void WriteMaterialProperties()
        {
            ...
            material.SetVector(
                "_SurfaceFoamMovement",
                new Vector4(surfaceFoamDirection1, surfaceFoamSpeed1, surfaceFoamDirection2, surfaceFoamSpeed2)
            );
            material.SetVector(
            ...
            material.SetVector(
                "_IntersectionFoamMovement",
                new Vector2(intersectionFoamDirection, intersectionFoamSpeed)
            );
            material.SetVector(
            ...
            material.SetVector(
                "_WaveDirections",
                new Vector4(waveDirection1, waveDirection2, waveDirection3, waveDirection4)
            );
        ...
        public float[] GetWaveDirections() => new[] { waveDirection1, waveDirection2, waveDirection3, waveDirection4 };
        ...
        [Range(0f, 1f)] public float reflectionStrength;

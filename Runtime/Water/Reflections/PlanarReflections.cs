...
namespace Procrain.Water.Reflections
{
    [ExecuteAlways]
    ...
    public class PlanarReflections : MonoBehaviour
    {
        ...
        private void UpdateReflectionCamera(Camera realCamera)
        {
            ...
            _reflectionCamera.gameObject.hideFlags =
                hideReflectionCamera ? HideFlags.HideAndDontSave : HideFlags.DontSave;
#if UNITY_EDITOR
        ...
        public static bool Compare(Vector2 a, Vector2 b) => a.x == b.x && a.y == b.y;

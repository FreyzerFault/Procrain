...
namespace Procrain.MapBuilder
{
    public class MeshDataBuilder_TIN: MeshDataBuilder
    {
        ...
        private IEnumerator BuildCoroutineInternal<T, TSafe>(
            T heightMapInput, ITerrainParams tinParams, Func<T, TSafe> toThreadSafe,
            ...
            Action onStart = null, Action<IMeshData> onEnd = null)
        {
            if (paralelized)
            {
                ...
                TINParams_ThreadSafe tp_ts = tinParams is TINParams_ThreadSafe tpts 
                    ? tpts 
                    : ((TINParams)tinParams).ToThreadSafe();
            ...
            {
                onStart?.Invoke();
                IMeshData meshData = buildMeshData(heightMapInput, tinParams, null);

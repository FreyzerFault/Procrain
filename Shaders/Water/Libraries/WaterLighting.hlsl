...
void MainLighting_half(half3 positionWS, half3 normalWS, half3 viewWS, half smoothness, out half specular,
                       out half diffuse)
{
    specular = 0;
    diffuse = 0;
...
void AdditionalLighting_half(half3 positionWS, half3 normalWS, half3 viewWS, half smoothness, half hardness,
                             out half3 specular, out half3 diffuse)
{
    specular = 0;
    diffuse = 0;
